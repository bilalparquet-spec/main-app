...
import { AskAIDrivePage } from "./components/pages/AskAIDrivePage.jsx";
...
export default function App() {
  ...
  const tx = {
    ...
    tz: { explore:"ⵙⵏⵓⴱⴳ", searchTab:"ⵔⵣⵓ", favorites:"ⵉⵎⵢⴰⴼⴰⴹ", trips:"ⵉⵎⴻⴷⴷⵓⴽⴰⵍ", messages:"ⵉⵣⵏⴰⵏ", profile:"ⵓⴳⴳⴰⵔ", loginRequired:"ⵙⵙⴻⴽⵛⴻⵎ ⴰⴼⴰⴷ ⴰⴷ ⵜⴻⴽⵎⴻⵍⴻⴷ", loginSub:"", login:"ⴽⵛⵎ", register:"ⵙⵏⵓⵍⴼⵓ ⴰⵎⵉⴹⴰⵏ", nearby:"ⵉⵖⵔⴻⴱ", suggest:"ⵙⵓⵎⵔ ⵜⴰⵀⵔⴰⴽⵜ", search:"ⵔⵣⵓ: ⵜⴰⵀⵔⴰⴽⵜ, ⵜⴰⵎⵏⴰⴹⵜ..." }
  }[appLang];
