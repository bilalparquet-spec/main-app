  ...
  return (
    <div style={{ borderTop: "1px solid rgba(255,255,255,.12)", borderBottom: "1px solid rgba(255,255,255,.12)", padding: "15px 0" }}>
      <div style={{ display: "grid", gridTemplateColumns: "46px 1fr", gap: 10, alignItems: "start" }}>
        <PlatformMark />
        <div>
          <h2 style={{ margin: "0 0 6px", color: "#fff", fontSize: 16.5, fontWeight: 950, letterSpacing: ".2px" }}>مرحباً بك في Drive RENT</h2>
    ...
    <div className="tiny-ui" style={{ minHeight: "calc(100vh - 170px)", padding: "4px 0 104px", animation: "fadeUp .28s ease", background: "#050506", color: "#fff" }}>
      ...
      {tab === "notifications" ? (
        <section style={{ padding: "14px 0 0" }}>
          <div style={{ textAlign: "center", borderTop: "1px solid rgba(255,255,255,.12)", borderBottom: "1px solid rgba(255,255,255,.12)", padding: "10px 0", marginBottom: 16, color: "rgba(255,255,255,.88)", fontSize: 11, fontWeight: 950, letterSpacing: ".8px" }}>النشاط</div>
          <NotificationCard />
