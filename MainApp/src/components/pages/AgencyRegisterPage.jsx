...
export function AgencyRegisterPage({ onBack } = {}) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      // استخدام service role عبر anon key مع الـ user id مباشرة
      ...
      const prRes = await fetch(`${SUPABASE_URL}/rest/v1/profiles?on_conflict=id`, {
        method: "POST",
      ...
      if (!prRes.ok) {
        ...
        throw new Error(prErr?.message || "فشل إنشاء الملف الشخصي");
      }
