            ...
            <>
              <div style={bookingPageBodyStyle}>
                ...
                <div style={{ ...smallCardStyle, padding: 16, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 14px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>📅 تاريخ الرحلة</h3>
                ...
                {/* الموقع */}
                <div style={{ ...smallCardStyle, padding: 16, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 12px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>📍 موقع الاستلام</h3>
                ...
                <div style={{ ...smallCardStyle, padding: 14, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 12px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>💰 ملخص السعر</h3>
          ...
          {bookingStep === "driver" && (
            <>
              <div style={bookingPageBodyStyle}>
                ...
                {/* بيانات السائق */}
                <div style={{ ...smallCardStyle, padding: 16, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 16px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>🪪 بيانات السائق</h3>
          ...
          {bookingStep === "review" && (
            <>
              <div style={bookingPageBodyStyle}>
                ...
                {/* تفاصيل الرحلة */}
                <div style={{ ...smallCardStyle, padding: 14, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 12px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>📋 ملخص الحجز</h3>
                ...
                {/* بيانات السائق */}
                <div style={{ ...smallCardStyle, padding: 14, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 12px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>🪪 بيانات السائق</h3>
                ...
                {/* ملخص السعر النهائي */}
                <div style={{ ...smallCardStyle, padding: 14, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 12px", color: "#fff", fontSize: 14.5, fontWeight: 950 }}>💰 السعر النهائي</h3>
              ...
              <footer style={bookingPageFooterStyle}>
                ...
                <button
                  ...
                  style={{ ...bookButtonStyle, opacity: termsAccepted ? 1 : 0.45 }}
                >
                  تأكيد الحجز ✓
                </button>
              </footer>
