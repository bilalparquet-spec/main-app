        ...
        <div style={bookingPageStyle}>
          ...
          <div style={bookingPageBodyStyle}>
            ...
            <div style={sectionStyle}>
              ...
              {/* سطر التسعيرة اليومية */}
              <div style={{ ...priceRowStyle, marginBottom: 7 }}>
                <span style={{ color: "rgba(255,255,255,.55)", fontSize: 11.5 }}>
                  {dailyPrice.toLocaleString("fr-DZ")} دج × {days} يوم
                </span>
                <strong>{formatDzd(baseTotal)}</strong>
              </div>
              <div style={{ ...priceRowStyle, marginBottom: 7 }}>
                <span style={{ color: "rgba(255,255,255,.55)", fontSize: 11.5 }}>رسوم المنصة 5%</span>
                <strong>{formatDzd(platformFee)}</strong>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", paddingTop: 12, borderTop: "1px solid rgba(255,255,255,.1)" }}>
                <span style={{ fontSize: 13, fontWeight: 800, color: "rgba(255,255,255,.75)" }}>الإجمالي</span>
                <div style={{ textAlign: "left", display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 1 }}>
                  <strong style={{ color: "#A78BFA", fontSize: 18, fontWeight: 950, letterSpacing: ".5px" }}>{formatDzd(total)}</strong>
                  <span style={{ color: "rgba(255,255,255,.35)", fontSize: 10.5 }}>{days} يوم شامل الرسوم</span>
                </div>
              </div>
            </div>
          ...
          <footer style={bookingPageFooterStyle}>
            <div style={{ minWidth: 0 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 1 }}>
                <span style={oldPriceStrikeStyle}>{formatDzd(oldDisplayBase)}</span>
                <strong style={{ ...realPriceStyle, color: "#A78BFA", fontSize: 17 }}>{formatDzd(total)}</strong>
                <div style={{ color: "rgba(255,255,255,.42)", fontWeight: 700, fontSize: 10.4 }}>شامل رسوم المنصة · {days} يوم</div>
              </div>
            </div>
            <button
              type="button"
