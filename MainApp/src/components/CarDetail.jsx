        ...
        <div style={bookingPageStyle}>
          ...
          <div style={bookingPageBodyStyle}>
            ...
            <div style={sectionStyle}>
              ...
              <div style={{ ...priceRowStyle, marginBottom: 9 }}>
                <span>تسعيرة السيارة ({days} يوم)</span>
              ...
              <div style={{ ...priceRowStyle, color: "#fff", fontSize: 14.5, fontWeight: 900, paddingTop: 12, borderTop: "1px solid rgba(255,255,255,.08)" }}>
                <span>السعر الإجمالي</span>
                <strong style={{ color: "#A78BFA", fontSize: 15.5 }}>{formatDzd(total)}</strong>
              </div>
            </div>
