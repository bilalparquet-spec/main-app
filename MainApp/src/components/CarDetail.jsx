          ...
          {bookingStep === "form" ? (
            <>
              <div style={bookingPageBodyStyle}>
                ...
                <div style={{ ...smallCardStyle, padding: 14, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 14px", color: "#fff", fontSize: 16, fontWeight: 950, textAlign: dir === "ltr" ? "left" : "right" }}>معلومات السائق الرئيسي</h3>
                ...
                <div style={{ ...smallCardStyle, padding: 14, background: "rgba(255,255,255,.045)" }}>
                  <h3 style={{ margin: "0 0 12px", color: "#fff", fontSize: 16, fontWeight: 950, textAlign: dir === "ltr" ? "left" : "right" }}>ملخص الحجز</h3>
                  ...
                  <div style={{ ...priceRowStyle, color: "#fff", fontSize: 13.8, paddingTop: 10, borderTop: "1px solid rgba(255,255,255,.08)" }}><span>السعر الإجمالي</span><strong>{formatDzd(total)}</strong></div>
                </div>
              ...
              <footer style={bookingPageFooterStyle}>
                ...
                <button type="button" onClick={() => setBookingStep("review")} style={bookButtonStyle}>متابعة</button>
              </footer>
            </>
          ) : (
            <>
