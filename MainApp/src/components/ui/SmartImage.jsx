...
import { optimizeImg, imgSizes } from "../../lib/imageOptimizer.js";
...
export function SmartImage({
  ...
  // ── تحسين الصورة بـ WebP حسب النوع ──────────────────────────────────────
  const optimizedSrc = src
    ? (variant === "avatar"  ? imgSizes.avatar(src)
     : variant === "agency"  ? imgSizes.agency(src)
     : variant === "gallery" ? imgSizes.detail(src)
     :                         imgSizes.card(src))
    : src;
