...
export function BookingConfirmSheet({ booking, onClose, onViewTrips, syncFailed = false }) {
          ...
          {syncFailed && (
            <div style={{
              ...
              <p style={{ margin: 0, fontSize: 12, color: "#FDE68A", lineHeight: 1.6 }}>
                تم حفظ الحجز على جهازك لكن لم يصل للسيرفر بسبب مشكلة في الاتصال. سيُرسَل تلقائياً عند عودة الاتصال — تأكد من اتصالك بالإنترنت.
              </p>
            </div>
          )}
        </div>
