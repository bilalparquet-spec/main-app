...
Object.assign(UI.tz = UI.tz || {}, {
  ...
  "أكثر": "ⵓⴳⴳⴰⵔ",
  "تسجيل الدخول": "ⵙⵙⵉⴷⴼ",
  "إنشاء حساب": "ⵙⵏⵓⵍⴼⵓ ⴰⵎⵉⴹⴰⵏ",
  "إنشاء حساب جديد": "ⵙⵏⵓⵍⴼⵓ ⴰⵎⵉⴹⴰⵏ ⴰⵎⴰⵢⵏⵓ",
  "سجّل الدخول للمتابعة": "ⵙⵙⵉⴷⴼ ⴰⴽⴽⵏ ⴰⴷ ⵜⴽⵎⵎⵍⴷ",
  "هذه الصفحة مخصصة للمستخدمين المسجلين.": "ⵜⴰⵙⵏⴰ ⴰⴷ ⵉ ⵉⵎⵙⵙⵎⵔⴰⵙ ⵉⵏⵏⵓⵍⴼⴰⵏ.",
  "قريب مني": "ⵇⵔⵉⴱ ⵖⵓⵔⵉ",
  "اقترح لي سيارة": "ⵙⵓⵎⵔ ⵉⵢⵉ ⵜⴰⴽⴰⵔⵓⵙⵜ",
  "ابحث: سيارة، ولاية، نوع...": "ⵔⵣⵓ: ⵜⴰⴽⴰⵔⵓⵙⵜ، ⵜⴰⵡⵉⵍⴰⵢⵜ، ⴰⵏⴰⵡ...",
  "أجر سيارتك المثالية بكل سهولة": "ⴽⵔⵉ ⵜⴰⴽⴰⵔⵓⵙⵜ ⵉⵎⵏⴰⴷⵏ ⵙ ⵜⵉⵙⵉⵙⵉ",
  "تحديد الموقع...": "ⴰⵙⵖⵏⵣⵉ ⵏ ⵓⴷⵖⴰⵔ...",
  "أكثر من +1000 سيارة تنتظركم": "+1000 ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⴰⴽⴽⵏ ⴰⴽⵏ ⵜⵜⵔⴰⵊⵓⵏⵜ",
  "سيارات في": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⴷⵉ",
  "فلتر": "ⵉⴼⵉⵍⵜⵔⵏ",
  "فلاتر": "ⵉⴼⵉⵍⵜⵔⵏ",
  "الفلاتر": "ⵉⴼⵉⵍⵜⵔⵏ",
  "الكل": "ⴰⴽⴽ",
  ...
  "مقاعد": "ⵉⵎⵉⵔⴰⵏ",
  "عرض الكل": "ⵙⴽⵏ ⴰⴽⴽ",
  "الوكالات المميزة": "ⵜⵉⵡⴰⴽⴰⵍⵉⵏ ⵜⵉⵎⵢⴰⵣⵉⵏ",
  "وكالات موثقة بأعلى التقييمات": "ⵜⵉⵡⴰⴽⴰⵍⵉⵏ ⵉⵜⵜⵡⴰⵙⵏⵜⵎⵏ ⵙ ⵜⵉⵣⵎⵎⴰⵔ ⵜⵉⴼⵓⵍⴽⵉⵏ",
  "وكالات": "ⵜⵉⵡⴰⴽⴰⵍⵉⵏ",
  "أفضل وكالات في ولاية": "ⵜⵉⵡⴰⴽⴰⵍⵉⵏ ⵉⴼⵓⵍⴽⵉⵏ ⴷⵉ ⵜⵡⵉⵍⴰⵢⵜ",
  "سيارات الزفاف": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵏ ⵜⵎⵖⵔⴰ",
  "سيارات الMariage": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵏ ⵜⵎⵖⵔⴰ",
  "ليلة لا تُنسى تستحق السيارة المثالية": "ⵉⴹ ⵓⵔ ⵉⵜⵜⵓⵏⵜⵜⵓ ⵉⵙⵜⴰⵀⵍ ⵜⴰⴽⴰⵔⵓⵙⵜ ⵉⵎⵏⴰⴷⵏ",
  "ليلة لا تُنسى تستحق الVoiture المثالية": "ⵉⴹ ⵓⵔ ⵉⵜⵜⵓⵏⵜⵜⵓ ⵉⵙⵜⴰⵀⵍ ⵜⴰⴽⴰⵔⵓⵙⵜ ⵉⵎⵏⴰⴷⵏ",
  "Voitures de mariage ليلة لا تُنسى تستحق الVoiture المثالية": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵏ ⵜⵎⵖⵔⴰ · ⵉⴹ ⵓⵔ ⵉⵜⵜⵓⵏⵜⵜⵓ ⵉⵙⵜⴰⵀⵍ ⵜⴰⴽⴰⵔⵓⵙⵜ ⵉⵎⵏⴰⴷⵏ",
  "سيارات رباعية الدفع 4X4": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ 4X4",
  "تمتع بتجربة قيادتها على رمال الصحراء الكبرى": "ⵙⴼⵔⵃ ⵙ ⵜⴰⵔⵎⵉⵜ ⵏ ⵓⵙⵙⵉⵡⴹ ⴷⵉ ⵉⵊⴷⵉ ⵏ ⵚⵚⴰⵃⵔⴰ",
  "السيارات الفاخرة": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵜⵉⵔⵇⵉⵇⵉⵏ",
  "تجربة قيادة استثنائية": "ⵜⴰⵔⵎⵉⵜ ⵏ ⵓⵙⵙⵉⵡⴹ ⵜⴰⵎⵢⴰⵣⵜ",
  "سيارات الفان": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⴼⴰⵏ",
  "اختيار عملي للعائلات والرحلات الجماعية": "ⴰⴼⵔⴰⵏ ⵉⵙⵀⵍⵏ ⵉ ⵜⵡⴰⵛⵓⵍⵉⵏ ⴷ ⵜⵉⵔⵣⴰ ⵜⵉⴳⵔⴰⵡⴰⵏⵉⵏ",
  "السيارات الكهربائية": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵜⵉⴽⴰⵀⵔⴰⴱⵉⵏ",
  "تنقل هادئ واقتصادي بتقنيات حديثة": "ⴰⵏⴰⵇⵍ ⵉⵀⴷⵏ ⴷ ⵉⵙⵀⵍⵏ ⵙ ⵜⵉⴽⵏⵓⵍⵓⵊⵉⵢⵉⵏ ⵜⵉⵎⴰⵢⵏⵓⵜⵉⵏ",
  "كل الوكالات": "ⴰⴽⴽ ⵜⵉⵡⴰⴽⴰⵍⵉⵏ",
  "استعرض جميع الوكالات المعتمدة في الجزائر": "ⵙⴽⵏ ⴰⴽⴽ ⵜⵉⵡⴰⴽⴰⵍⵉⵏ ⵉⵎⵓⵜⵜⵇⴰⵏ ⴷⵉ ⴷⵣⴰⵢⵔ",
  "كل سيارات الزفاف": "ⴰⴽⴽ ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵏ ⵜⵎⵖⵔⴰ",
  "سيارات فاخرة للمناسبات والأعراس": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵜⵉⵔⵇⵉⵇⵉⵏ ⵉ ⵜⵎⵖⵔⵉⵡⵉⵏ ⴷ ⵉⵎⴰⵢⵔⴰⵙ",
  "كل السيارات الفاخرة": "ⴰⴽⴽ ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵜⵉⵔⵇⵉⵇⵉⵏ",
  "اختيارات راقية لتجربة قيادة مميزة": "ⵉⴼⵔⴰⵏ ⵉⵔⵇⵇⴰⵏ ⵉ ⵜⴰⵔⵎⵉⵜ ⵏ ⵓⵙⵙⵉⵡⴹ ⵜⴰⵎⵢⴰⵣⵜ",
  "كل سيارات رباعية الدفع 4X4": "ⴰⴽⴽ ⵜⵉⴽⴰⵔⵓⵙⵉⵏ 4X4",
  "كل سيارات الفان": "ⴰⴽⴽ ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⴼⴰⵏ",
  "سيارات عملية للعائلات والرحلات الجماعية": "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵉⵙⵀⵍⵏ ⵉ ⵜⵡⴰⵛⵓⵍⵉⵏ ⴷ ⵜⵉⵔⵣⴰ ⵜⵉⴳⵔⴰⵡⴰⵏⵉⵏ",
  "كل السيارات الكهربائية": "ⴰⴽⴽ ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⵜⵉⴽⴰⵀⵔⴰⴱⵉⵏ",
  "مشاركة": "ⴱⴹⵓ",
  "مفضلة": "ⵉⵎⴰⵖⵏⴰⵙⵏ",
  "رجوع": "ⵓⵖⴰⵍ",
  "وكالة موثقة": "ⵜⴰⵡⴰⴽⴰⵍⵜ ⵉⵜⵜⵡⴰⵙⵏⵜⵎⵏ",
  "عدد السيارات": "ⵓⵟⵟⵓⵏ ⵏ ⵜⵉⴽⴰⵔⵓⵙⵉⵏ",
  "العنوان": "ⴰⵏⵙⴰ",
  "أوقات العمل": "ⵉⵙⵡⵉⵢⵏ ⵏ ⵜⵡⵓⵔⵉ",
  "كل يوم · 24/7": "ⴽⵓⵍ ⴰⵙⵙ · 24/7",
  "تواصل مع الوكالة": "ⵎⵢⴰⵡⴰⴹ ⴷ ⵜⵡⴰⴽⴰⵍⵜ",
  "إضافة للمفضلة": "ⵔⵏⵓ ⵖⵔ ⵉⵎⴰⵖⵏⴰⵙⵏ",
  "🇩🇿 منصة جزائرية": "🇩🇿 ⵜⴰⵙⴷⴰⵡⵉⵜ ⵜⴰⴷⵣⴰⵢⵔⵉⵜ",
  "أكثر من": "ⵓⴳⴳⴰⵔ ⵏ",
  "1500 سيارة": "1500 ⵜⴰⴽⴰⵔⵓⵙⵜ",
  "فاخرة · اقتصادية · كهربائية · زفاف": "ⵜⴰⵔⵇⵉⵇⵜ · ⵜⴰⴷⵔⵉⵎⴰⵏⵜ · ⵜⴰⴽⴰⵀⵔⴰⴱⵉⵜ · ⵜⴰⵎⵖⵔⴰ",
  "كلها تنتظر حجزك الآن": "ⴰⴽⴽ ⴰⵇⵇⵍⵏⵜ ⵜⵜⵔⴰⵊⵓⵏⵜ ⴰⵃⵊⵊⵓⵣ ⵏⵏⴽ ⵜⵓⵔⴰ",
  "ولاية": "ⵜⴰⵡⵉⵍⴰⵢⵜ",
  "📍 تغطية شاملة": "📍 ⵜⴰⵖⵓⵔⵉ ⵜⴰⵎⴰⵜⵜⵓⵜ",
  "في كل": "ⴷⵉ ⴽⵓⵍ",
  "ولاية جزائرية": "ⵜⴰⵡⵉⵍⴰⵢⵜ ⵜⴰⴷⵣⴰⵢⵔⵉⵜ",
  "من الجزائر العاصمة إلى تمنراست": "ⵙⴳ ⴷⵣⴰⵢⵔ ⵜⴰⵎⴰⵏⴰⵖⵜ ⴰⵔ ⵜⵎⵏⵔⴰⵙⵜ",
  "احجز سيارتك أينما كنت": "ⵃⵊⵊⵣ ⵜⴰⴽⴰⵔⵓⵙⵜ ⵏⵏⴽ ⵎⴰⵏⵉ ⵜⵍⵍⵉⴷ",
  "وقت الحجز": "ⴰⴽⵓⴷ ⵏ ⵓⵃⵊⵊⵓⵣ",
  "خدمة": "ⵜⴰⵏⴼⵍⵉⵜ",
  "🛡️ أمان تام": "🛡️ ⵜⴰⵖⵍⵍⵉⵙⵜ ⵜⴰⵎⴰⵜⵜⵓⵜ",
  "وكالات موثقة": "ⵜⵉⵡⴰⴽⴰⵍⵉⵏ ⵉⵜⵜⵡⴰⵙⵏⵜⵎⵏ",
  "كل وكالة مفحوصة ومعتمدة رسمياً": "ⴽⵓⵍ ⵜⴰⵡⴰⴽⴰⵍⵜ ⵜⴻⵜⵜⵡⴰⵙⵏⵇⴷ ⴷ ⵜⴻⵜⵜⵡⴰⵇⴱⵍ ⵙ ⵓⵙⵎⵉⴷ",
  "تأمين شامل وإلغاء مجاني": "ⵜⴰⵙⵉⵙⵜ ⵜⴰⵎⴰⵜⵜⵓⵜ ⴷ ⵓⵙⵏⴼⵙ ⵉⵍⵍⴰⵏ",
  "تقييم": "ⵜⴰⵣⵎⵎⴰⵔⵜ",
  "موثوقية": "ⵜⵉⵡⴽⵍⴰ",
  "مشاكل": "ⵉⵎⵓⴽⵔⵉⵙⵏ",
  "⚡ سريع وسهل": "⚡ ⵉⵣⵔⴱ ⴷ ⵉⵙⵀⵍ",
  "ابدأ رحلتك في": "ⴱⴷⵓ ⵜⵉⵔⵣⵉ ⵏⵏⴽ ⴷⵉ",
  "3 خطوات": "3 ⵉⵎⵓⵙⵙⵓⵜⵏ",
  "ابحث · اختر · احجز": "ⵔⵣⵓ · ⴼⵔⵏ · ⵃⵊⵊⵣ",
  "بدون تعقيدات، بدون انتظار": "ⴱⵍⴰ ⵉⵎⵓⴽⵔⵉⵙⵏ، ⴱⵍⴰ ⵜⵜⵔⴰⵊⵓ",
  "خطوات": "ⵉⵎⵓⵙⵙⵓⵜⵏ",
  "فوري": "ⴷⵖⵢⴰ",
  "تأكيد": "ⴰⵙⵏⵜⵎ",
  "مجاني": "ⴱⴰⵟⵍ",
  ...
  "RENT درايف": "Drive RENT",
  "درايف": "Drive",
  "أضف وكالتك": "ⵔⵏⵓ ⵜⴰⵡⴰⴽⴰⵍⵜ ⵏⵏⴽ",
  "جديدة": "ⵜⴰⵎⴰⵢⵏⵓⵜ",
  "الأفضل": "ⵜⴰⴼⵓⵍⴽⵉⵜ",
  "مميز": "ⴰⵎⵢⴰⵣ",
  "جاري التحميل...": "ⴰⵔ ⵉⵜⵜⴰⵍⵉ...",
  "موقعك": "ⴰⴷⵖⴰⵔ ⵏⵏⴽ",
  "استخدام موقعي": "ⵙⵙⵎⵔⵙ ⴰⴷⵖⴰⵔ ⵏⵉ",
  "السماح بالموقع": "ⵙⵙⵓⵔⴳ ⵉ ⵓⴷⵖⴰⵔ",
  "اختيار يدوي": "ⴰⴼⵔⴰⵏ ⵙ ⵓⴼⵓⵙ",
  "تخطي": "ⵣⵔⵉ",
  "متابعة": "ⴽⵎⵎⵍ"
});
...
Object.assign(UI.fr, {
  ...
  "ليلة لا تُنسى تستحق السيارة المثالية": "Une nuit inoubliable mérite la voiture parfaite",
  "ليلة لا تُنسى تستحق الVoiture المثالية": "Une nuit inoubliable mérite la voiture parfaite",
  "Voitures de mariage ليلة لا تُنسى تستحق الVoiture المثالية": "Voitures de mariage · Une nuit inoubliable mérite la voiture parfaite",
  "فلاتر": "Filtres",
  "الفلاتر": "Filtres",
...
Object.assign(UI.en, {
  ...
  "ليلة لا تُنسى تستحق السيارة المثالية": "A night to remember deserves the perfect car",
  "ليلة لا تُنسى تستحق الVoiture المثالية": "A night to remember deserves the perfect car",
  "Voitures de mariage ليلة لا تُنسى تستحق الVoiture المثالية": "Wedding cars · A night to remember deserves the perfect car",
  "فلاتر": "Filters",
  "الفلاتر": "Filters",
...
// Tamazight option uses the native Tifinagh dictionary above.
UI.tz = UI.tz || {};
WILAYAS.tz = WILAYAS.tz || WILAYAS.en || {};
...
const PLACEHOLDERS = {
  ...
  tz: {
    "ابحث: سيارة، ولاية، نوع...":"ⵔⵣⵓ: ⵜⴰⴽⴰⵔⵓⵙⵜ، ⵜⴰⵡⵉⵍⴰⵢⵜ، ⴰⵏⴰⵡ...",
    "ابحث عن ولايتك...":"ⵔⵣⵓ ⵖⴼ ⵜⵡⵉⵍⴰⵢⵜ ⵏⵏⴽ...",
    "مثال: محمد أمين":"ⴰⵎⴷⵢⴰ: ⵎⵓⵃⴰⵎⴷ ⴰⵎⵉⵏ",
    "اكتب تعليقك على السيارة...":"ⴰⵔⵓ ⵜⴰⵖⵣⵉⵏⵜ ⵏⵏⴽ ⵖⴼ ⵜⴰⴽⴰⵔⵓⵙⵜ...",
    "اكتب رسالة سريعة...":"ⴰⵔⵓ ⵉⵣⵏ ⵉⵣⵔⴱⵏ...",
    "مثال: وكالة الجزائر بريميوم":"ⴰⵎⴷⵢⴰ: ⵜⴰⵡⴰⴽⴰⵍⵜ ⴷⵣⴰⵢⵔ ⴱⵔⵉⵎⵢⵓⵎ",
    "example@email.com":"example@email.com",
  }
};
...
export function tText(text, lang) {
  ...
  if (lang === "fr") {
    ...
    out = out
      .replace(/([\d\s.,]+)\s*دج/g, "$1 ⴷⴰ")
      .replace(/دج\s*\/\s*يوم/g, "ⴷⴰ/ⴰⵙⵙ")
      .replace(/الإجمالي/g, "ⴰⵎⴰⵜⴰⵢ")
      .replace(/اليوم/g, "ⴰⵙⵙ")
      .replace(/([0-9]+)\s*يوم/g, "$1 ⴰⵙⵙ")
      .replace(/(\d+)\s*مقاعد/g, "$1 ⵉⵎⵉⵔⴰⵏ")
      .replace(/(\d+)\s*سيارة/g, "$1 ⵜⵉⴽⴰⵔⵓⵙⵉⵏ")
      .replace(/(\d+)\s*رحلة/g, "$1 ⵜⵉⵔⵣⴰ")
      .replace(/(\d+)\s*ألف كم/g, "$1 ⴰⵍⴼ ⴽⵎ")
      .replace(/سيارات في\s+(.+)/, "ⵜⵉⴽⴰⵔⵓⵙⵉⵏ ⴷⵉ $1")
      .replace(/تاريخ الاستلام:/g, "ⴰⵣⵎⵣ ⵏ ⵓⵙⵙⵉⵡⴹ:")
      .replace(/تاريخ الإرجاع:/g, "ⴰⵣⵎⵣ ⵏ ⵜⵓⵖⴰⵍⵜ:")
      .replace(/الاسم:/g, "ⵉⵙⵎ:")
      .replace(/الهاتف:/g, "ⵜⵉⵍⵉⴼⵓⵏ:");
  }
  return out;
}
