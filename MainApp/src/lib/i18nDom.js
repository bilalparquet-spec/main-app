...
Object.assign(UI.fr, {
  ...
  "تطبيق": "Appliquer",
  "السعر اليومي (دج)": "Prix par jour (DA)",
  "الوكالات الموثقة فقط": "Agences vérifiées seulement",
  "علبة الرسائل": "Boîte de messages",
  "الرسائل": "MESSAGES",
  "الإشعارات": "NOTIFICATIONS",
  "النشاط": "Activité",
  "مرحباً بك في Drive RENT": "Bonjour et bienvenue sur Drive RENT",
  "شكراً لانضمامك إلى المنصة. رحلتك تبدأ من هنا.": "Merci de rejoindre la plateforme. Votre trajet commence ici.",
  "لا توجد رسائل حتى الآن": "Aucun message pour le moment",
  "الآن": "Maintenant"
});
...
Object.assign(UI.en, {
  ...
  "الإشعارات": "NOTIFICATIONS",
  "النشاط": "Activity",
  "مرحباً بك في Drive RENT": "Hello and welcome to Drive RENT",
  "شكراً لانضمامك إلى المنصة. رحلتك تبدأ من هنا.": "Thank you for joining the platform. Your journey starts here.",
  "لا توجد رسائل حتى الآن": "No messages yet",
  "الآن": "Now"
});

UI.tz = { ...(UI.ar || {}),
  "تجربة قيادة استثنائية": "ⵜⵊⵔⴱⵜ ⵏ ⵓⵙⵙⵉⵡⴹ ⴰⵎⴰⵣⴰⵏ",
  "اختيار عملي للعائلات والرحلات الجماعية": "ⴰⵙⵜⴰⵢ ⴰⵎⵙⴰⵔⵓ ⵉ ⵜⵡⴰⵛⵓⵍⵉⵏ ⴷ ⵉⵎⵓⴷⴷⴰⵏ ⵏ ⵜⴳⵔⴰⵡⵍⴰ",
  "كهربائي": "ⴰⵎⵙⵉⵍⴰⵏ",
  "علبة الرسائل": "ⵜⴰⵏⴽⵓⵜ ⵏ ⵢⵉⵣⵏⴰⵏ",
  "الرسائل": "ⵉⵣⵏⴰⵏ",
  "الإشعارات": "ⵉⵙⴼⴽⴰⵏ",
  "النشاط": "ⴰⵏⴰⵎⵓⵔ",
  "لا توجد رسائل حتى الآن": "ⵓⵔ ⵉⵍⵍⵉ ⵢⵉⵣⵏⴰⵏ ⴰⵔ ⵜⵓⵔⴰ",
  "الآن": "ⵜⵓⵔⴰ"
};
