...
const UI = {
  ...
  tz: {
    "ابحث: سيارة، ولاية، نوع...":"ⵔⵣⵓ: ⵜⴰⵀⵔⴰⴽⵜ، ⵜⴰⵎⵏⴰⴹⵜ...",
    "ابحث عن ولايتك...":"ⵔⵣⵓ ⵖⴼ ⵜⴰⵎⵏⴰⴹⵜ...",
    "اكتب تعليقك على السيارة...":"ⴰⵔⵓ ⴰⵡⴰⵍⵉⴽ...",
    "اكتب رسالة سريعة...":"ⴰⵔⵓ ⵉⵣⴻⵏ..."
  }
};
...
const TIFINAGH_MAP = {"ا":"ⴰ","أ":"ⴰ","إ":"ⵉ","آ":"ⴰ","ب":"ⴱ","ت":"ⵜ","ث":"ⵝ","ج":"ⵊ","ح":"ⵃ","خ":"ⵅ","د":"ⴷ","ذ":"ⴹ","ر":"ⵔ","ز":"ⵣ","س":"ⵙ","ش":"ⵛ","ص":"ⵚ","ض":"ⴹ","ط":"ⵟ","ظ":"ⵥ","ع":"ⵄ","غ":"ⵖ","ف":"ⴼ","ق":"ⵇ","ك":"ⴽ","ل":"ⵍ","م":"ⵎ","ن":"ⵏ","ه":"ⵀ","و":"ⵡ","ي":"ⵢ","ى":"ⴰ","ة":"ⵜ"};
const TZ_MANUAL = {
  "سيارات الزفاف":"ⵜⵉⵀⵔⴰⴽⵉⵏ ⵏ ⵓⵣⵍⴰⵢ",
  "ليلة لا تُنسى تستحق السيارة المثالية":"ⵉⴹ ⵓⵔ ⵜⵜⵓⵜⵜⵢⴰⵏ ⵜⴻⵃⵡⴰⵊ ⵜⴰⵀⵔⴰⴽⵜ ⵜⴰⵎⴻⴳⴳⴰⵣⵜ",
  "الفلاتر":"ⵉⵙⴼⵉⵍⵜⵔⴻⵏ",
  "السعر اليومي (دج)":"ⴰⵜⵉⴳ ⵏ ⵡⴰⵙⵙ (ⴷⵊ)",
  "الوكالات الموثقة فقط":"ⵜⵉⵡⴽⴰⵍ ⵉⵜⵜⵓⵙⴻⵏⵜⴻⵏ ⴽⴰⵏ",
  "Ask Drive Rent":"Ask AI Drive Rent"
};
function arabicToTifinagh(text = "") {
  return String(text).split("").map((c) => TIFINAGH_MAP[c] || c).join("");
}
UI.tz = new Proxy(UI.ar || {}, { get(target, prop) { return TZ_MANUAL[prop] || arabicToTifinagh(target[prop] || prop); } });
...
export function tText(text, lang) {
  ...
  if (lang === "tz") return TZ_MANUAL[text] || arabicToTifinagh(text);
