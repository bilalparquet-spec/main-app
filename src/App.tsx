...
const supabase = createClient(
  "https://xtxgvymigvwrhcsogmdj.supabase.co",
...
function AuthModal({lang,onClose,onLogin}){
  ...
  const submitRegister=()=>{
    ...
    // Save to Supabase for real-time admin notification
    ...
    }).then(({error})=>{ if(error) console.warn("Supabase register error:",error.message); });
    setRegSent(true);
  };
