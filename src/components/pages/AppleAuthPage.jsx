...
export function AppleAuthPage({ onBack, onSuccess }) {
  ...
  function handleConfirm() {
    setLoading(true);
    setTimeout(() => {
      if (onSuccess) onSuccess({ ...mockAppleUser, usedProxy: hideEmail });
    }, 1000);
  }
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, padding: "20px 24px 50px", maxWidth: 480, width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
