      ...
      {tab === "notifications" ? (
        <section style={{ padding: "14px 0 0" }}>
          ...
          <div style={{ display: "grid", placeItems: "center", paddingTop: 22, color: "rgba(255,255,255,.72)" }}>
            <span style={{ width: 34, height: 34, borderRadius: 999, border: "2px solid rgba(255,255,255,.72)", display: "grid", placeItems: "center", overflow: "hidden" }}><img src="/logo-source.png" alt="logo" style={{ width: 18, height: 18, objectFit: "contain" }} /></span>
          </div>
        </section>
      ) : (
        messages.length ? (
