      ...
      <div style={{ flex: 1, padding: "28px 24px 40px", maxWidth: "clamp(320px,92vw,520px)", width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div>
            ...
            <input type="email" placeholder="example@email.com" value={email} onChange={e => setEmail(e.target.value)} onFocus={() => setFocusEl("email")} onBlur={() => setFocusEl(null)} style={inputStyle("email")} onKeyDown={e => e.key === "Enter" && handleLogin()}/>
          </div>
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              <input type={showPass ? "text" : "password"} placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} onFocus={() => setFocusEl("pass")} onBlur={() => setFocusEl(null)} style={{ ...inputStyle("pass"), paddingLeft: 44 }} onKeyDown={e => e.key === "Enter" && handleLogin()}/>
