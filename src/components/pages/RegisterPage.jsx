      ...
      <div style={{ position: "relative", height: 180, flexShrink: 0, overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", bottom: 16, left: 0, right: 0, textAlign: "center" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(10,11,23,.6)", backdropFilter: "blur(12px)", padding: "6px 16px 6px 10px", borderRadius: 40, border: "1px solid rgba(167,139,250,.25)" }}>
            <img src={LOGO_IMG} alt="logo" style={{ width: 26, height: 26, borderRadius: 8, objectFit: "cover", flexShrink: 0 }}/>
            <span style={{ fontWeight: 900, fontSize: 14, background: "linear-gradient(90deg,#A78BFA,#818CF8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Rent&درايف</span>
          </div>
        </div>
      </div>
