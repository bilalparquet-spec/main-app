...
/** ⚡ استهلاك الوقود / MPG */
export function IconMpg({ size = 18, color = "currentColor" }) {
  return (
    <Svg size={size}>
      <path d="M12 2L8 8h3v4l5-6h-3z"
        stroke={color} strokeWidth={S} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
