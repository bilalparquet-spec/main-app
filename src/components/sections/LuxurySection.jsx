          ...
          <div key={car.id} className="btn-press" onClick={()=>onOpen(car)} style={{
            ...
            <div style={{ position:"relative", height:148, overflow:"hidden", background:"#0D0E1A" }}>
              ...
              <div style={{ position:"absolute", bottom:8, left:10, right:10, display:"flex", gap:5 }}>
                ...
                <span style={{ background:"rgba(0,0,0,.65)", backdropFilter:"blur(6px)", color:"rgba(255,255,255,.8)", padding:"2px 7px", borderRadius:20, fontSize:9, fontWeight:700 }}>💺 {car.seats}</span>
              </div>
            </div>
            <div style={{ padding:"12px 14px" }}>
              ...
              <div style={{ fontSize:10, color:"rgba(255,255,255,.35)", marginBottom:9 }}>📍 {car.wilaya}</div>
