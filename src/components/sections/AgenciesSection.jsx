          ...
          <div key={ag.id} className="btn-press" style={{
            ...
            <div style={{ position:"relative", height:100, overflow:"hidden", background:"#0D0E1A" }}>
              ...
              <button onClick={e=>{e.stopPropagation();setLiked(p=>{const n=new Set(p);n.has(ag.id)?n.delete(ag.id):n.add(ag.id);return n;});}}
                ...
                <svg width="12" height="12" viewBox="0 0 24 24" fill={liked.has(ag.id)?"#EF4444":"none"} stroke={liked.has(ag.id)?"#EF4444":"rgba(255,255,255,.7)"} strokeWidth="2.5"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
              </button>
            </div>
