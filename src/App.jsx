    ...
    <div style={{minHeight:"100vh",background:"#07080F",color:"#F1F5F9",overscrollBehavior:"contain"}}>
      ...
      <nav style={{position:"sticky",top:0,zIndex:100,background:"rgba(7,8,15,.92)",backdropFilter:"blur(18px)",borderBottom:"1px solid rgba(255,255,255,.07)",padding:"0 clamp(12px,3vw,24px)",height:"var(--nav-height, 58px)",display:"flex",alignItems:"center",gap:"clamp(8px,2vw,16px)"}}>
        <div onClick={()=>{setPage("home");setSelCar(null);setSelAgency(null);}} style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",flexShrink:0}}>
          <img src={LOGO_IMG} alt="logo" style={{width:32,height:32,objectFit:"contain",flexShrink:0}}/>
        ...
        <button onClick={()=>setAgencyRegister(true)} className="agency-btn-glow" style={{
          ...
          onMouseEnter={e=>{e.currentTarget.style.background="rgba(109,40,217,.38)";e.currentTarget.style.borderColor="rgba(167,139,250,.9)";e.currentTarget.style.transform="scale(1.06)";}}
          onMouseLeave={e=>{e.currentTarget.style.background="rgba(109,40,217,.22)";e.currentTarget.style.borderColor="rgba(167,139,250,.55)";e.currentTarget.style.transform="scale(1)";}}>
          <span style={{
            position:"absolute", inset:-4, borderRadius:18,
            border:"2px solid rgba(167,139,250,.45)",
            animation:"agencyPulseRing 2s ease-out infinite",
            pointerEvents:"none",
          }}/>
          <span style={{
