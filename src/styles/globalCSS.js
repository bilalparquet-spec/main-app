const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  @keyframes agencyGlow{0%,100%{box-shadow:0 0 10px 2px rgba(139,92,246,.45),0 0 28px 6px rgba(99,102,241,.22),0 2px 18px 0 rgba(167,139,250,.18)}50%{box-shadow:0 0 22px 6px rgba(167,139,250,.75),0 0 48px 14px rgba(99,102,241,.38),0 4px 32px 0 rgba(139,92,246,.32)}}
  @keyframes agencyPulseRing{0%{transform:scale(1);opacity:.7}100%{transform:scale(1.55);opacity:0}}
  @keyframes agencyShimmer{0%{background-position:-200% center}100%{background-position:200% center}}
  ...
  .agency-btn-glow{position:relative;animation:agencyGlow 2.2s ease-in-out infinite;background:linear-gradient(135deg,rgba(109,40,217,.22) 0%,rgba(79,70,229,.18) 50%,rgba(139,92,246,.22) 100%)!important;border-color:rgba(167,139,250,.55)!important;}
  .agency-btn-glow::before{content:'';position:absolute;inset:-3px;border-radius:17px;background:linear-gradient(135deg,#A78BFA,#6366F1,#8B5CF6,#A78BFA);background-size:300% 300%;animation:agencyShimmer 3s linear infinite;z-index:-1;opacity:.6;filter:blur(5px);}
  .agency-btn-glow::after{content:'';position:absolute;inset:-1px;border-radius:16px;border:1.5px solid transparent;background:linear-gradient(135deg,rgba(167,139,250,.8),rgba(99,102,241,.5),rgba(139,92,246,.8)) border-box;-webkit-mask:linear-gradient(#fff 0 0) padding-box,linear-gradient(#fff 0 0);-webkit-mask-composite:destination-out;mask-composite:exclude;}
